...
class Produits{
    ...
    public function lire(){
        ...
        // On retourne le résultat. On ne passe par l'étape fetch ici mais dans le "fichier API" lire.php
        return $query;
    }
